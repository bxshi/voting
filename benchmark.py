...
for i in range(10, 50, 5):
    ...
    os.system('./bench_worker.py '+str(RUN_TIME)+' fh_all zipf '+str(float(i)/10)+' "'+get_file_list(FILE_NUM, 'fh_test_')+'"')
...
for i in range(10, 50, 5):
    ...
    os.system('./bench_worker.py '+str(RUN_TIME)+' fsh_all zipf '+str(float(i)/10)+' "'+get_file_list(FILE_NUM, 'fsh_test_')+'"')
